...
<!-- <div class="containe">
  ...
  <div class="row">
  <div class="col-lg-12">   
    <h3 align="center"> Deleted Pet's list: </h3>
  <table class="table table-borderless"  style="margin-top:1rem; opacity:60%; filter: alpha(opacity=50); -moz-opacity: 0.2; -khtml-opacity: 0.2;">
      ...
      <?php 
      $query = "SELECT Pid, Pname, Pdob, Psex, Pweight,img, Ptype, husbandry, user, Pdisable FROM pets WHERE user = '$user' AND Pdisable = '1' ";
