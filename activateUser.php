...
if(isset($_POST['but_delete'])){
    ...
    if(isset($_POST['delete'])){
        foreach($_POST['delete'] as $deleteid){
            echo $deleteid;
        $deleteUser = "Update users SET Udisable ='0'  WHERE memID=".$deleteid;
 ...
 <!-- <div class="col-md-6 col-md-offset-4">
                            ...
                            swal({
                                ...
                                .then((willDelete) => {
                                    if (willDelete) {
                                        ...
                                        swal({
                                            title: "The user is still deactive",
                                            // text: "You clicked the button!",
                                            icon: "info",
                                            button: "ok!",
                                            });
  ...
  <div class="container"> 
    ...
    <table class="table table-borderless" >
     ...
     <?php 
     $query = "SELECT memID, user, email FROM users WHERE Udisable = '1' ";
   ...
   <div class ="mainpadding" align = "center">
    ...
    <input class= "btn btn-outline-danger btn-block" type='submit' value='Activated' name='buti_delete'><br><br>
