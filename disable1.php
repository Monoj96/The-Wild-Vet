...
if(isset($_POST['but_delete'])){
    ...
    if(isset($_POST['delete'])){
        foreach($_POST['delete'] as $deleteid){
            echo $deleteid;
        $deleteUser = "Update pets SET Pdisable ='1'  WHERE Pid=".$deleteid;
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a  href="homeCopy.php">home</a></li>
 ...
 <!-- <div class="col-md-6 col-md-offset-4">
  ...
  <div class="container"> 
    ...
    <table class="table table-borderless" >
     ...
     <?php 
     $query = "SELECT Pid, Pname, Pdob, Psex, Pweight, user, Pdisable FROM pets WHERE  Pdisable ='0' ";
   ...
   <div class ="mainpadding" align = "center">
    <p><strong>Note: Please select the pet before pressing the disable button. Once deleted, you will not be able to recover this pet!</strong></p>
    <input class= "btn btn-outline-danger btn-block" type='submit' value='Disable' name='buti_delete'><br><br>
